                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto col-12">
                            <h1 class="hero-title text-center mb-5">Change Password</h1>

                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form id="loginForm"  method="post">
                                        <div class="form-floating mb-4">
                                            <input type="password" name="newpassword" id="email" minlength="8" class="form-control" placeholder="New Password" required>
                                            
                                        </div>
                                        <div class="form-floating mb-4">
                                            <input type="password" name="confirmpassword" id="email" minlength="8" class="form-control" placeholder="Confirm Password" required>
